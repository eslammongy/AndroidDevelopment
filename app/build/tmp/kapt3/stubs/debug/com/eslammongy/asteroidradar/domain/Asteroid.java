...
public final class Asteroid implements android.os.Parcelable {
    ...
    public static final android.os.Parcelable.Creator<com.eslammongy.asteroidradar.domain.Asteroid> CREATOR = null;
    
    @org.jetbrains.annotations.NotNull()
    public final com.eslammongy.asteroidradar.domain.Asteroid copy(long id, @org.jetbrains.annotations.NotNull()
    ...
    public Asteroid(long id, @org.jetbrains.annotations.NotNull()
    java.lang.String codename, @org.jetbrains.annotations.NotNull()
    java.lang.String closeApproachDate, double absoluteMagnitude, double estimatedDiameter, double relativeVelocity, double distanceFromEarth, boolean isPotentiallyHazardous) {
        super();
    }
    ...
    public static final class Creator implements android.os.Parcelable.Creator<com.eslammongy.asteroidradar.domain.Asteroid> {
        ...
        @org.jetbrains.annotations.NotNull()
        @java.lang.Override()
        public final com.eslammongy.asteroidradar.domain.Asteroid createFromParcel(@org.jetbrains.annotations.NotNull()
        ...
        @org.jetbrains.annotations.NotNull()
        @java.lang.Override()
        public final com.eslammongy.asteroidradar.domain.Asteroid[] newArray(int size) {
            return null;
        }
    }
}